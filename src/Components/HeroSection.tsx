        ...
        <div >
            <div className=' max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-20 grid grid-cols-1 md:grid-cols-12 gap-8 items-center '>
                ...
                <div className='md:col-span-7 flex flex-col justify-center '>
                    <h1 className='text-3xl md:text-5xl font-bold bg-linear-to-r/oklab from-red-600 via-violet-600 to-indigo-300 bg-clip-text text-transparent'>Build Your Ideal</h1>
